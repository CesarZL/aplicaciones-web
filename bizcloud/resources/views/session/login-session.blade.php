            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-2">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">¡Bienvenid@ de vuelta!</h3>
                  <p class="mb-0">Inicia sesión y accede al éxito de tu empresa en un par de clics</p>
                </div>
                <div class="card-body">
                ...
                <small class="text-muted">¿Olvidaste tu contraseña? Restáurala 
                  <a href="/login/forgot-password" class="text-info text-gradient font-weight-bold">Aquí</a>
                </small>
                  <p class="mb-4 text-sm mx-auto">
                    ¿No tienes cuenta?
                    <a href="register" class="text-info text-gradient font-weight-bold">Crea una</a>
                  </p>
                </div>
              </div>
            </div>
